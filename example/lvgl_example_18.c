#include "lvgl/lvgl.h"
#include "_img_clockwise_hour_alpha_18x98.c"
#include "_img_clockwise_min_alpha_18x157.c"
#include "_img_clockwise_sec_alpha_31x180.c"
...
{	
    ...
    lv_analogclock_set_hour_needle_img(screen_analog_clock_1, &_img_clockwise_hour_alpha_18x98, 8, 8);
    lv_analogclock_set_min_needle_img(screen_analog_clock_1, &_img_clockwise_min_alpha_18x157, 8, 8);
    lv_analogclock_set_sec_needle_img(screen_analog_clock_1, &_img_clockwise_sec_alpha_31x180, 24, 15);
    lv_analogclock_set_time(screen_analog_clock_1, 1, 2,30);
